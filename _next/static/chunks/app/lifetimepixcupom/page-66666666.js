...
modal.innerHTML = `
  <div class="bg-white p-6 rounded-lg flex flex-col items-center gap-4">
    ...
    <img src="https://i.imgur.com/7lxzYWY.png" class="w-48 h-48" alt="QR CODE">
          <p class="font-bold text-sm">Pix Copia e Cola</p>
    <div class="flex items-center gap-2">
<input type="text" readonly value="00020126470014BR.GOV.BCB.PIX0125bernardopbbueno@gmail.com520400005303986540513.005802BR5908Move Hub6013Nao interessa62070503***63042144" class="border p-1 rounded bg-black text-white"/>
